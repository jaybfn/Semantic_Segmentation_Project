...
_ a. train_sm.py for training training the model wit your dataset:
__ i. When you run the script train_sm.py, the script creates a folder with a predefined name call ´´´results´´´ and subfolders called:
