...
from UNET_RESNET152 import UNET_RESNET152
...
new_folder = 'unet_resnet152_output_2' 
...
# calling the model from UNET_RESNER152.py script
...
if __name__ == "__main__":
    ...
    # initilizing the model UNET_RESNET152
    def get_Model():
            return UNET_RESNET152(n_classes = n_classes ,IMAGE_HEIGHT = IMG_HEIGHT, IMAGE_WIDTH = IMG_WIDTH, IMAGE_CHANNELS = IMG_CHANNELS)
    model = get_Model()
